...
public abstract class CropImageActivity extends MonitoredActivity {
    ...
    public void initCrop(CropImageView imageView, int aspectX, int aspectY) {
...
//                Logger.e(e);
    ...
    private void startCrop() {
        ...
        CropUtil.startBackgroundJob(this, null, getResources().getString(R.string.common_crop_tips_waiting),
                new Runnable() {
                    public void run() {
    ...
    private class Cropper {
        ...
        private void makeDefault() {
            ...
            HighlightView hv = new HighlightView(imageView, ImageCropProxy.getThemeConfig().getMainElementsColor());
    ...
    private void saveImage(Bitmap croppedImage, final File saveFile) {
        if (croppedImage != null) {
            ...
            CropUtil.startBackgroundJob(this, null, getResources().getString(R.string.common_crop_tips_saving),
                    new Runnable() {
                        public void run() {
        ...
        if (saveFile != null) {
            ...
            try {
                ...
                if (outputStream != null) {
                    String ext = Utils.getFileExtension(saveFile.getAbsolutePath());
